...
[source,groovy]
./src/main/groovy/org/grails/gactions/ColorRequestHandler.groovy
----
include::{sourceDir}/src/main/groovy/org/grails/gactions/ColorRequestHandler.groovy[indent=0]
----
